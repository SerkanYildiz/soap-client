...
1. [Create your own SOAP client.](client.md)
2. [Generate PHP classes based on SOAP types.](cli/generate-types.md)
3. [Generate a class map](cli/generate-classmap.md)
4. [Generate your own SOAP client.](cli/generate-client.md)
5. [Generate a client factory.](cli/generate-clientfactory.md)
6. [Use your SOAP client.](usage.md)
7. [Test your SOAP client.](testing.md)

## Advanced configuration

- [Add type converters.](type-converter.md)
...
- [Specify your data transfer handler.](handlers.md)
  - [SoapHandle](handlers.md#soaphandle)
  - [HTTPlugHandle](handlers.md#httplughandle)
  - [LocalSoapServerHandle](handlers.md#localsoapserverhandle)
- [Configure one or multiple HTTP middlewares.](middlewares.md)
  - [BasicAuthMiddleware](middlewares.md#basicauthmiddleware)
  - [NtlmMiddleware](middlewares.md#ntlmmiddleware)
  - [WsaMiddleware](middlewares.md#wsamiddleware)
  - [WsseMiddleware](middlewares.md#wssemiddleware)
- [Select a WSDL Provider](wsdl-providers.md)


## Customize the code generation

- [Configuration](code-generation/configuration.md)
- [Specify generation `Rules`](code-generation/rules.md)
- [Generate code through `Assemblers`](code-generation/assemblers.md)
